...
## Project Structure
    ...
    ├── testapiautodatamod_109628  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_109628`
...
2. Clone this repo and `cd testapiautodatamod_109628`
